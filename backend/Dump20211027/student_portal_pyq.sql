...
CREATE TABLE `pyq` (
  ...
  `pyear` int NOT NULL,
  `ccode` char(6) DEFAULT NULL,
  `fpath` varchar(50) DEFAULT NULL,
  PRIMARY KEY (`pid`),
  KEY `ccode` (`ccode`),
  CONSTRAINT `pyq_ibfk_1` FOREIGN KEY (`ccode`) REFERENCES `course` (`ccode`)
...
-- Dump completed on 2021-10-27 11:33:38
